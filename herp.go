...
import (
	...
	"github.com/chloetigre/herp/bridge"
)
...
var useAddressFromLabel = flag.String("useAddressFromLabel", "", "Use URI stored in a label assigned to the container")
...
func main() {
	...
	b, err := bridge.New(docker, flag.Arg(0), bridge.Config{
		Explicit:            *explicit,
		UseAddressFromLabel: *useAddressFromLabel,
		ForceTags:           *forceTags,
